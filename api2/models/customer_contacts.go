...
//
// swagger:model CustomerContacts
...
// Validate validates this customer contacts
func (m *CustomerContacts) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CustomerContacts) validateBankname(formats strfmt.Registry) error {
...
func (m *CustomerContacts) validateBic(formats strfmt.Registry) error {
...
func (m *CustomerContacts) validateCity(formats strfmt.Registry) error {
...
func (m *CustomerContacts) validateCompany(formats strfmt.Registry) error {
...
func (m *CustomerContacts) validateComregnum(formats strfmt.Registry) error {
...
func (m *CustomerContacts) validateCountry(formats strfmt.Registry) error {
...
func (m *CustomerContacts) validateEmail(formats strfmt.Registry) error {
...
func (m *CustomerContacts) validateFaxnumber(formats strfmt.Registry) error {
...
func (m *CustomerContacts) validateFirstname(formats strfmt.Registry) error {
...
func (m *CustomerContacts) validateGpp0(formats strfmt.Registry) error {
...
func (m *CustomerContacts) validateGpp1(formats strfmt.Registry) error {
...
func (m *CustomerContacts) validateGpp2(formats strfmt.Registry) error {
...
func (m *CustomerContacts) validateGpp3(formats strfmt.Registry) error {
...
func (m *CustomerContacts) validateGpp4(formats strfmt.Registry) error {
...
func (m *CustomerContacts) validateGpp5(formats strfmt.Registry) error {
...
func (m *CustomerContacts) validateGpp6(formats strfmt.Registry) error {
...
func (m *CustomerContacts) validateGpp7(formats strfmt.Registry) error {
...
func (m *CustomerContacts) validateGpp8(formats strfmt.Registry) error {
...
func (m *CustomerContacts) validateGpp9(formats strfmt.Registry) error {
...
func (m *CustomerContacts) validateIban(formats strfmt.Registry) error {
...
func (m *CustomerContacts) validateLastname(formats strfmt.Registry) error {
...
func (m *CustomerContacts) validateMobilenumber(formats strfmt.Registry) error {
...
func (m *CustomerContacts) validatePhonenumber(formats strfmt.Registry) error {
...
func (m *CustomerContacts) validatePostcode(formats strfmt.Registry) error {
...
func (m *CustomerContacts) validateResellerID(formats strfmt.Registry) error {
...
func (m *CustomerContacts) validateStreet(formats strfmt.Registry) error {
...
func (m *CustomerContacts) validateTimezone(formats strfmt.Registry) error {
...
func (m *CustomerContacts) validateVatnum(formats strfmt.Registry) error {
...
func (m *CustomerContacts) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CustomerContacts) UnmarshalBinary(b []byte) error {
	var res CustomerContacts
