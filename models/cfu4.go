...
// Validate validates this cfu4
func (m *Cfu4) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Cfu4) validateBnumberset(formats strfmt.Registry) error {
...
func (m *Cfu4) validateBnumbersetID(formats strfmt.Registry) error {
...
func (m *Cfu4) validateDestinationset(formats strfmt.Registry) error {
...
func (m *Cfu4) validateDestinationsetID(formats strfmt.Registry) error {
...
func (m *Cfu4) validateSourceset(formats strfmt.Registry) error {
...
func (m *Cfu4) validateSourcesetID(formats strfmt.Registry) error {
...
func (m *Cfu4) validateTimeset(formats strfmt.Registry) error {
...
func (m *Cfu4) validateTimesetID(formats strfmt.Registry) error {
...
func (m *Cfu4) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Cfu4) UnmarshalBinary(b []byte) error {
	var res Cfu4
