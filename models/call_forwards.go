...
// Validate validates this call forwards
func (m *CallForwards) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CallForwards) validateCfb(formats strfmt.Registry) error {
...
func (m *CallForwards) validateCfna(formats strfmt.Registry) error {
...
func (m *CallForwards) validateCfr(formats strfmt.Registry) error {
...
func (m *CallForwards) validateCfs(formats strfmt.Registry) error {
...
func (m *CallForwards) validateCft(formats strfmt.Registry) error {
...
func (m *CallForwards) validateCfu(formats strfmt.Registry) error {
...
func (m *CallForwards) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CallForwards) UnmarshalBinary(b []byte) error {
	var res CallForwards
