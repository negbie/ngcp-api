...
// Validate validates this cft5
func (m *Cft5) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Cft5) validateBnumberset(formats strfmt.Registry) error {
...
func (m *Cft5) validateBnumbersetID(formats strfmt.Registry) error {
...
func (m *Cft5) validateDestinationset(formats strfmt.Registry) error {
...
func (m *Cft5) validateDestinationsetID(formats strfmt.Registry) error {
...
func (m *Cft5) validateSourceset(formats strfmt.Registry) error {
...
func (m *Cft5) validateSourcesetID(formats strfmt.Registry) error {
...
func (m *Cft5) validateTimeset(formats strfmt.Registry) error {
...
func (m *Cft5) validateTimesetID(formats strfmt.Registry) error {
...
func (m *Cft5) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Cft5) UnmarshalBinary(b []byte) error {
	var res Cft5
