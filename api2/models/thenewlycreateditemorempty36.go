...
func (m *Thenewlycreateditemorempty36) validateDomain(formats strfmt.Registry) error {
...
func (m *Thenewlycreateditemorempty36) validateResellerID(formats strfmt.Registry) error {
