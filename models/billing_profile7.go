...
// BillingProfile7 BillingProfile7
// swagger:model BillingProfile7
type BillingProfile7 struct {
...
// Validate validates this billing profile7
func (m *BillingProfile7) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *BillingProfile7) validateAdviceOfCharge(formats strfmt.Registry) error {
...
func (m *BillingProfile7) validateCurrency(formats strfmt.Registry) error {
...
func (m *BillingProfile7) validateFraudDailyLimit(formats strfmt.Registry) error {
...
func (m *BillingProfile7) validateFraudDailyLock(formats strfmt.Registry) error {
...
func (m *BillingProfile7) validateFraudIntervalLimit(formats strfmt.Registry) error {
...
func (m *BillingProfile7) validateFraudIntervalLock(formats strfmt.Registry) error {
...
func (m *BillingProfile7) validateFraudUseResellerRates(formats strfmt.Registry) error {
...
func (m *BillingProfile7) validateHandle(formats strfmt.Registry) error {
...
func (m *BillingProfile7) validateIntervalCharge(formats strfmt.Registry) error {
...
func (m *BillingProfile7) validateIntervalFreeCash(formats strfmt.Registry) error {
...
func (m *BillingProfile7) validateIntervalFreeTime(formats strfmt.Registry) error {
...
func (m *BillingProfile7) validateName(formats strfmt.Registry) error {
...
func (m *BillingProfile7) validatePeaktimeSpecial(formats strfmt.Registry) error {
...
func (m *BillingProfile7) validatePeaktimeWeekdays(formats strfmt.Registry) error {
...
func (m *BillingProfile7) validatePrepaid(formats strfmt.Registry) error {
...
func (m *BillingProfile7) validatePrepaidLibrary(formats strfmt.Registry) error {
...
func (m *BillingProfile7) validateResellerID(formats strfmt.Registry) error {
...
func (m *BillingProfile7) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *BillingProfile7) UnmarshalBinary(b []byte) error {
	var res BillingProfile7
