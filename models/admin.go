...
func (m *Admin) validateBillingData(formats strfmt.Registry) error {
...
func (m *Admin) validateCallData(formats strfmt.Registry) error {
...
func (m *Admin) validateIsActive(formats strfmt.Registry) error {
...
func (m *Admin) validateIsMaster(formats strfmt.Registry) error {
...
func (m *Admin) validateIsSuperuser(formats strfmt.Registry) error {
...
func (m *Admin) validateLawfulIntercept(formats strfmt.Registry) error {
...
func (m *Admin) validateReadOnly(formats strfmt.Registry) error {
...
func (m *Admin) validateResellerID(formats strfmt.Registry) error {
...
func (m *Admin) validateShowPasswords(formats strfmt.Registry) error {
