...
// PbxDeviceModels1 PbxDeviceModels1
//
// swagger:model PbxDeviceModels1
type PbxDeviceModels1 struct {
	...
	// Required: true
	ConnectableModelsID *float64 `json:"connectable_models_id"`

	// extensions num
	// Required: true
	ExtensionsNum *float64 `json:"extensions_num"`
...
// Validate validates this pbx device models1
func (m *PbxDeviceModels1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PbxDeviceModels1) validateBootstrapConfigHTTPSyncMethod(formats strfmt.Registry) error {
...
func (m *PbxDeviceModels1) validateBootstrapConfigHTTPSyncParams(formats strfmt.Registry) error {
...
func (m *PbxDeviceModels1) validateBootstrapConfigHTTPSyncURI(formats strfmt.Registry) error {
...
func (m *PbxDeviceModels1) validateBootstrapConfigRedirectGrandstreamCid(formats strfmt.Registry) error {
...
func (m *PbxDeviceModels1) validateBootstrapConfigRedirectGrandstreamKey(formats strfmt.Registry) error {
...
func (m *PbxDeviceModels1) validateBootstrapConfigRedirectPanasonicPassword(formats strfmt.Registry) error {
...
func (m *PbxDeviceModels1) validateBootstrapConfigRedirectPanasonicUser(formats strfmt.Registry) error {
...
func (m *PbxDeviceModels1) validateBootstrapConfigRedirectPolycomPassword(formats strfmt.Registry) error {
...
func (m *PbxDeviceModels1) validateBootstrapConfigRedirectPolycomProfile(formats strfmt.Registry) error {
...
func (m *PbxDeviceModels1) validateBootstrapConfigRedirectPolycomUser(formats strfmt.Registry) error {
...
func (m *PbxDeviceModels1) validateBootstrapConfigRedirectSnomPassword(formats strfmt.Registry) error {
...
func (m *PbxDeviceModels1) validateBootstrapConfigRedirectSnomUser(formats strfmt.Registry) error {
...
func (m *PbxDeviceModels1) validateBootstrapConfigRedirectYealinkPassword(formats strfmt.Registry) error {
...
func (m *PbxDeviceModels1) validateBootstrapConfigRedirectYealinkUser(formats strfmt.Registry) error {
...
func (m *PbxDeviceModels1) validateBootstrapMethod(formats strfmt.Registry) error {
...
func (m *PbxDeviceModels1) validateBootstrapURI(formats strfmt.Registry) error {
...
func (m *PbxDeviceModels1) validateConnectableModelsID(formats strfmt.Registry) error {
...
func (m *PbxDeviceModels1) validateExtensionsNum(formats strfmt.Registry) error {
...
func (m *PbxDeviceModels1) validateLinerange(formats strfmt.Registry) error {
...
func (m *PbxDeviceModels1) validateModel(formats strfmt.Registry) error {
...
func (m *PbxDeviceModels1) validateResellerID(formats strfmt.Registry) error {
...
func (m *PbxDeviceModels1) validateType(formats strfmt.Registry) error {
...
func (m *PbxDeviceModels1) validateVendor(formats strfmt.Registry) error {
...
func (m *PbxDeviceModels1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PbxDeviceModels1) UnmarshalBinary(b []byte) error {
	var res PbxDeviceModels1
