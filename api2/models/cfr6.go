...
// Validate validates this cfr6
func (m *Cfr6) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Cfr6) validateBnumberset(formats strfmt.Registry) error {
...
func (m *Cfr6) validateBnumbersetID(formats strfmt.Registry) error {
...
func (m *Cfr6) validateDestinationset(formats strfmt.Registry) error {
...
func (m *Cfr6) validateDestinationsetID(formats strfmt.Registry) error {
...
func (m *Cfr6) validateSourceset(formats strfmt.Registry) error {
...
func (m *Cfr6) validateSourcesetID(formats strfmt.Registry) error {
...
func (m *Cfr6) validateTimeset(formats strfmt.Registry) error {
...
func (m *Cfr6) validateTimesetID(formats strfmt.Registry) error {
...
func (m *Cfr6) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Cfr6) UnmarshalBinary(b []byte) error {
	var res Cfr6
