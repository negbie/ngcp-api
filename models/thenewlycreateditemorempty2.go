...
func (m *Thenewlycreateditemorempty2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Thenewlycreateditemorempty2) UnmarshalBinary(b []byte) error {
	var res Thenewlycreateditemorempty2
