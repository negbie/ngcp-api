...
// InvoiceTemplateApiService InvoiceTemplateApi service
type InvoiceTemplateApiService service

// InvoicetemplatesGetOpts Optional parameters for the method 'InvoicetemplatesGet'
type InvoicetemplatesGetOpts struct {
...
/*
InvoicetemplatesGet Get InvoiceTemplate items
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *InvoicetemplatesGetOpts - Optional Parameters:
 * @param "ResellerId" (optional.String) -  Filter for invoice templates belonging to a specific reseller
 * @param "Name" (optional.String) -  Filter for invoice templates with a specific name
...
*/
func (a *InvoiceTemplateApiService) InvoicetemplatesGet(ctx _context.Context, localVarOptionals *InvoicetemplatesGetOpts) ([]InvoiceTemplate, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/invoicetemplates/"
...
/*
InvoicetemplatesIdGet Get a specific InvoiceTemplate
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
@return InvoiceTemplate
*/
func (a *InvoiceTemplateApiService) InvoicetemplatesIdGet(ctx _context.Context, id int32) (InvoiceTemplate, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/invoicetemplates/{id}"
