...
// Validate validates this createanew customer request
func (m *CreateanewCustomerRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CreateanewCustomerRequest) validateActivateTimestamp(formats strfmt.Registry) error {
...
func (m *CreateanewCustomerRequest) validateAddVat(formats strfmt.Registry) error {
...
func (m *CreateanewCustomerRequest) validateBillingProfileDefinition(formats strfmt.Registry) error {
...
func (m *CreateanewCustomerRequest) validateBillingProfileID(formats strfmt.Registry) error {
...
func (m *CreateanewCustomerRequest) validateBillingProfiles(formats strfmt.Registry) error {
...
func (m *CreateanewCustomerRequest) validateContactID(formats strfmt.Registry) error {
...
func (m *CreateanewCustomerRequest) validateCreateTimestamp(formats strfmt.Registry) error {
...
func (m *CreateanewCustomerRequest) validateExternalID(formats strfmt.Registry) error {
...
func (m *CreateanewCustomerRequest) validateInvoiceEmailTemplateID(formats strfmt.Registry) error {
...
func (m *CreateanewCustomerRequest) validateInvoiceTemplateID(formats strfmt.Registry) error {
...
func (m *CreateanewCustomerRequest) validateMaxSubscribers(formats strfmt.Registry) error {
...
func (m *CreateanewCustomerRequest) validateModifyTimestamp(formats strfmt.Registry) error {
...
func (m *CreateanewCustomerRequest) validatePassresetEmailTemplateID(formats strfmt.Registry) error {
...
func (m *CreateanewCustomerRequest) validateProfilePackageID(formats strfmt.Registry) error {
...
func (m *CreateanewCustomerRequest) validateStatus(formats strfmt.Registry) error {
...
func (m *CreateanewCustomerRequest) validateSubscriberEmailTemplateID(formats strfmt.Registry) error {
...
func (m *CreateanewCustomerRequest) validateTerminateTimestamp(formats strfmt.Registry) error {
...
func (m *CreateanewCustomerRequest) validateType(formats strfmt.Registry) error {
...
func (m *CreateanewCustomerRequest) validateVatRate(formats strfmt.Registry) error {
...
func (m *CreateanewCustomerRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CreateanewCustomerRequest) UnmarshalBinary(b []byte) error {
	var res CreateanewCustomerRequest
