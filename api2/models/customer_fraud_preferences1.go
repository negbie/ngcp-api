...
// CustomerFraudPreferences1 CustomerFraudPreferences1
//
// swagger:model CustomerFraudPreferences1
...
// Validate validates this customer fraud preferences1
func (m *CustomerFraudPreferences1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CustomerFraudPreferences1) validateFraudDailyLimit(formats strfmt.Registry) error {
...
func (m *CustomerFraudPreferences1) validateFraudDailyLock(formats strfmt.Registry) error {
...
func (m *CustomerFraudPreferences1) validateFraudDailyNotify(formats strfmt.Registry) error {
...
func (m *CustomerFraudPreferences1) validateFraudIntervalLimit(formats strfmt.Registry) error {
...
func (m *CustomerFraudPreferences1) validateFraudIntervalLock(formats strfmt.Registry) error {
...
func (m *CustomerFraudPreferences1) validateFraudIntervalNotify(formats strfmt.Registry) error {
...
func (m *CustomerFraudPreferences1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CustomerFraudPreferences1) UnmarshalBinary(b []byte) error {
	var res CustomerFraudPreferences1
