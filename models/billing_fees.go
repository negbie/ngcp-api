...
// Validate validates this billing fees
func (m *BillingFees) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *BillingFees) validateBillingProfileID(formats strfmt.Registry) error {
...
func (m *BillingFees) validateBillingZoneID(formats strfmt.Registry) error {
...
func (m *BillingFees) validateDestination(formats strfmt.Registry) error {
...
func (m *BillingFees) validateDirection(formats strfmt.Registry) error {
...
func (m *BillingFees) validateMatchMode(formats strfmt.Registry) error {
...
func (m *BillingFees) validateOffpeakFollowInterval(formats strfmt.Registry) error {
...
func (m *BillingFees) validateOffpeakFollowRate(formats strfmt.Registry) error {
...
func (m *BillingFees) validateOffpeakInitInterval(formats strfmt.Registry) error {
...
func (m *BillingFees) validateOffpeakInitRate(formats strfmt.Registry) error {
...
func (m *BillingFees) validateOnpeakFollowInterval(formats strfmt.Registry) error {
...
func (m *BillingFees) validateOnpeakFollowRate(formats strfmt.Registry) error {
...
func (m *BillingFees) validateOnpeakInitInterval(formats strfmt.Registry) error {
...
func (m *BillingFees) validateOnpeakInitRate(formats strfmt.Registry) error {
...
func (m *BillingFees) validatePurgeExisting(formats strfmt.Registry) error {
...
func (m *BillingFees) validateSource(formats strfmt.Registry) error {
...
func (m *BillingFees) validateUseFreeTime(formats strfmt.Registry) error {
...
func (m *BillingFees) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *BillingFees) UnmarshalBinary(b []byte) error {
	var res BillingFees
