...
// Validate validates this cfu6
func (m *Cfu6) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Cfu6) validateBnumberset(formats strfmt.Registry) error {
...
func (m *Cfu6) validateBnumbersetID(formats strfmt.Registry) error {
...
func (m *Cfu6) validateDestinationset(formats strfmt.Registry) error {
...
func (m *Cfu6) validateDestinationsetID(formats strfmt.Registry) error {
...
func (m *Cfu6) validateSourceset(formats strfmt.Registry) error {
...
func (m *Cfu6) validateSourcesetID(formats strfmt.Registry) error {
...
func (m *Cfu6) validateTimeset(formats strfmt.Registry) error {
...
func (m *Cfu6) validateTimesetID(formats strfmt.Registry) error {
...
func (m *Cfu6) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Cfu6) UnmarshalBinary(b []byte) error {
	var res Cfu6
