...
// Validate validates this s IP captures
func (m *SIPCaptures) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SIPCaptures) validateCallID(formats strfmt.Registry) error {
...
func (m *SIPCaptures) validateCseqMethod(formats strfmt.Registry) error {
...
func (m *SIPCaptures) validateDstIP(formats strfmt.Registry) error {
...
func (m *SIPCaptures) validateDstPort(formats strfmt.Registry) error {
...
func (m *SIPCaptures) validateFromURI(formats strfmt.Registry) error {
...
func (m *SIPCaptures) validateMethod(formats strfmt.Registry) error {
...
func (m *SIPCaptures) validateProtocol(formats strfmt.Registry) error {
...
func (m *SIPCaptures) validateRequestURI(formats strfmt.Registry) error {
...
func (m *SIPCaptures) validateSrcIP(formats strfmt.Registry) error {
...
func (m *SIPCaptures) validateSrcPort(formats strfmt.Registry) error {
...
func (m *SIPCaptures) validateTimestamp(formats strfmt.Registry) error {
...
func (m *SIPCaptures) validateTransport(formats strfmt.Registry) error {
...
func (m *SIPCaptures) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SIPCaptures) UnmarshalBinary(b []byte) error {
	var res SIPCaptures
