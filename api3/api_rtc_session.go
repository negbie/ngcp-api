...
// RtcSessionApiService RtcSessionApi service
type RtcSessionApiService service

// RtcsessionsGetOpts Optional parameters for the method 'RtcsessionsGet'
type RtcsessionsGetOpts struct {
...
/*
RtcsessionsGet Get RtcSession items
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *RtcsessionsGetOpts - Optional Parameters:
...
*/
func (a *RtcSessionApiService) RtcsessionsGet(ctx _context.Context, localVarOptionals *RtcsessionsGetOpts) ([]map[string]interface{}, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/rtcsessions/"
...
/*
RtcsessionsIdGet Get a specific RtcSession
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
@return map[string]interface{}
*/
func (a *RtcSessionApiService) RtcsessionsIdGet(ctx _context.Context, id int32) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/rtcsessions/{id}"
...
/*
RtcsessionsPost Create a new RtcSession
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body
@return []map[string]interface{}
*/
func (a *RtcSessionApiService) RtcsessionsPost(ctx _context.Context, body map[string]interface{}) ([]map[string]interface{}, *_nethttp.Response, error) {
	var (
