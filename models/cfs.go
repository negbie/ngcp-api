...
// Validate validates this cfs
func (m *Cfs) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Cfs) validateBnumbers(formats strfmt.Registry) error {
...
func (m *Cfs) validateBnumbersIsRegex(formats strfmt.Registry) error {
...
func (m *Cfs) validateBnumbersMode(formats strfmt.Registry) error {
...
func (m *Cfs) validateDestinations(formats strfmt.Registry) error {
...
func (m *Cfs) validateSources(formats strfmt.Registry) error {
...
func (m *Cfs) validateSourcesIsRegex(formats strfmt.Registry) error {
...
func (m *Cfs) validateSourcesMode(formats strfmt.Registry) error {
...
func (m *Cfs) validateTimes(formats strfmt.Registry) error {
...
func (m *Cfs) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Cfs) UnmarshalBinary(b []byte) error {
	var res Cfs
