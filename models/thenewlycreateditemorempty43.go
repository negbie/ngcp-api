...
func (m *Thenewlycreateditemorempty43) validateBillingProfileID(formats strfmt.Registry) error {
...
func (m *Thenewlycreateditemorempty43) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Thenewlycreateditemorempty43) UnmarshalBinary(b []byte) error {
	var res Thenewlycreateditemorempty43
