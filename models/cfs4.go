...
// Validate validates this cfs4
func (m *Cfs4) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Cfs4) validateBnumberset(formats strfmt.Registry) error {
...
func (m *Cfs4) validateBnumbersetID(formats strfmt.Registry) error {
...
func (m *Cfs4) validateDestinationset(formats strfmt.Registry) error {
...
func (m *Cfs4) validateDestinationsetID(formats strfmt.Registry) error {
...
func (m *Cfs4) validateSourceset(formats strfmt.Registry) error {
...
func (m *Cfs4) validateSourcesetID(formats strfmt.Registry) error {
...
func (m *Cfs4) validateTimeset(formats strfmt.Registry) error {
...
func (m *Cfs4) validateTimesetID(formats strfmt.Registry) error {
...
func (m *Cfs4) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Cfs4) UnmarshalBinary(b []byte) error {
	var res Cfs4
