...
// Validate validates this cft6
func (m *Cft6) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Cft6) validateBnumberset(formats strfmt.Registry) error {
...
func (m *Cft6) validateBnumbersetID(formats strfmt.Registry) error {
...
func (m *Cft6) validateDestinationset(formats strfmt.Registry) error {
...
func (m *Cft6) validateDestinationsetID(formats strfmt.Registry) error {
...
func (m *Cft6) validateSourceset(formats strfmt.Registry) error {
...
func (m *Cft6) validateSourcesetID(formats strfmt.Registry) error {
...
func (m *Cft6) validateTimeset(formats strfmt.Registry) error {
...
func (m *Cft6) validateTimesetID(formats strfmt.Registry) error {
...
func (m *Cft6) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Cft6) UnmarshalBinary(b []byte) error {
	var res Cft6
