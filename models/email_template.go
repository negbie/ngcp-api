...
func (m *EmailTemplate) validateAttachmentName(formats strfmt.Registry) error {
...
func (m *EmailTemplate) validateFromEmail(formats strfmt.Registry) error {
...
func (m *EmailTemplate) validateName(formats strfmt.Registry) error {
...
func (m *EmailTemplate) validateResellerID(formats strfmt.Registry) error {
