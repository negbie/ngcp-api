...
func (m *TopupLog) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TopupLog) validateAmount(formats strfmt.Registry) error {
...
func (m *TopupLog) validateCashBalanceAfter(formats strfmt.Registry) error {
...
func (m *TopupLog) validateCashBalanceBefore(formats strfmt.Registry) error {
...
func (m *TopupLog) validateContractBalanceAfterID(formats strfmt.Registry) error {
...
func (m *TopupLog) validateContractBalanceBeforeID(formats strfmt.Registry) error {
...
func (m *TopupLog) validateContractID(formats strfmt.Registry) error {
...
func (m *TopupLog) validateLockLevelAfter(formats strfmt.Registry) error {
...
func (m *TopupLog) validateLockLevelBefore(formats strfmt.Registry) error {
...
func (m *TopupLog) validateMessage(formats strfmt.Registry) error {
...
func (m *TopupLog) validateOutcome(formats strfmt.Registry) error {
...
func (m *TopupLog) validatePackageAfterID(formats strfmt.Registry) error {
...
func (m *TopupLog) validatePackageBeforeID(formats strfmt.Registry) error {
...
func (m *TopupLog) validateProfileAfterID(formats strfmt.Registry) error {
...
func (m *TopupLog) validateProfileBeforeID(formats strfmt.Registry) error {
...
func (m *TopupLog) validateRequestToken(formats strfmt.Registry) error {
...
func (m *TopupLog) validateSubscriberID(formats strfmt.Registry) error {
...
func (m *TopupLog) validateTimestamp(formats strfmt.Registry) error {
...
func (m *TopupLog) validateType(formats strfmt.Registry) error {
...
func (m *TopupLog) validateUsername(formats strfmt.Registry) error {
...
func (m *TopupLog) validateVoucherID(formats strfmt.Registry) error {
...
func (m *TopupLog) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TopupLog) UnmarshalBinary(b []byte) error {
	var res TopupLog
