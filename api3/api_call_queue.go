...
// CallQueueApiService CallQueueApi service
type CallQueueApiService service

// CallqueuesGetOpts Optional parameters for the method 'CallqueuesGet'
type CallqueuesGetOpts struct {
...
/*
CallqueuesGet Get CallQueue items
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *CallqueuesGetOpts - Optional Parameters:
 * @param "ResellerId" (optional.String) -  Filter for callqueues of subscribers belonging to a specific reseller
 * @param "Number" (optional.String) -  Filter for callqueues of subscribers with numbers matching the given pattern.
...
@return []CallQueue
*/
func (a *CallQueueApiService) CallqueuesGet(ctx _context.Context, localVarOptionals *CallqueuesGetOpts) ([]CallQueue, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  []CallQueue
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/callqueues/"
...
/*
CallqueuesIdGet Get a specific CallQueue
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
@return CallQueue
*/
func (a *CallQueueApiService) CallqueuesIdGet(ctx _context.Context, id int32) (CallQueue, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/callqueues/{id}"
