...
// Validate validates this cfb
func (m *Cfb) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Cfb) validateBnumbers(formats strfmt.Registry) error {
...
func (m *Cfb) validateBnumbersIsRegex(formats strfmt.Registry) error {
...
func (m *Cfb) validateBnumbersMode(formats strfmt.Registry) error {
...
func (m *Cfb) validateDestinations(formats strfmt.Registry) error {
...
func (m *Cfb) validateSources(formats strfmt.Registry) error {
...
func (m *Cfb) validateSourcesIsRegex(formats strfmt.Registry) error {
...
func (m *Cfb) validateSourcesMode(formats strfmt.Registry) error {
...
func (m *Cfb) validateTimes(formats strfmt.Registry) error {
...
func (m *Cfb) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Cfb) UnmarshalBinary(b []byte) error {
	var res Cfb
