...
// Validate validates this cfu
func (m *Cfu) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Cfu) validateBnumbers(formats strfmt.Registry) error {
...
func (m *Cfu) validateBnumbersIsRegex(formats strfmt.Registry) error {
...
func (m *Cfu) validateBnumbersMode(formats strfmt.Registry) error {
...
func (m *Cfu) validateDestinations(formats strfmt.Registry) error {
...
func (m *Cfu) validateSources(formats strfmt.Registry) error {
...
func (m *Cfu) validateSourcesIsRegex(formats strfmt.Registry) error {
...
func (m *Cfu) validateSourcesMode(formats strfmt.Registry) error {
...
func (m *Cfu) validateTimes(formats strfmt.Registry) error {
...
func (m *Cfu) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Cfu) UnmarshalBinary(b []byte) error {
	var res Cfu
