...
// BalanceIntervalApiService BalanceIntervalApi service
type BalanceIntervalApiService service

// BalanceintervalsGetOpts Optional parameters for the method 'BalanceintervalsGet'
type BalanceintervalsGetOpts struct {
...
/*
BalanceintervalsGet Get BalanceInterval items
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *BalanceintervalsGetOpts - Optional Parameters:
 * @param "ResellerId" (optional.String) -  Filter for actual balance intervals of customers belonging to a specific reseller
...
*/
func (a *BalanceIntervalApiService) BalanceintervalsGet(ctx _context.Context, localVarOptionals *BalanceintervalsGetOpts) ([]BalanceInterval, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  []BalanceInterval
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/balanceintervals/"
...
/*
BalanceintervalsIdGet Get a specific BalanceInterval
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
@return BalanceInterval
*/
func (a *BalanceIntervalApiService) BalanceintervalsIdGet(ctx _context.Context, id int32) (BalanceInterval, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/balanceintervals/{id}"
