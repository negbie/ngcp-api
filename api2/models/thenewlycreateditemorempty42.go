...
func (m *Thenewlycreateditemorempty42) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Thenewlycreateditemorempty42) UnmarshalBinary(b []byte) error {
	var res Thenewlycreateditemorempty42
