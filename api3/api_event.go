...
// EventsGetOpts Optional parameters for the method 'EventsGet'
type EventsGetOpts struct {
...
/*
EventsGet Get Event items
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *EventsGetOpts - Optional Parameters:
 * @param "SubscriberId" (optional.String) -  Filter for events of a specific subscriber.
 * @param "ResellerId" (optional.String) -  Filter for events for customers/subscribers of a specific reseller.
 * @param "Type_" (optional.String) -  Filter for events of a specific type.
 * @param "TimestampFrom" (optional.String) -  Filter for events occurred after or at the given time stamp.
 * @param "TimestampTo" (optional.String) -  Filter for events occurred before or at the given time stamp.
...
@return []Event
*/
func (a *EventApiService) EventsGet(ctx _context.Context, localVarOptionals *EventsGetOpts) ([]Event, *_nethttp.Response, error) {
	var (
...
/*
EventsIdGet Get a specific Event
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
@return Event
*/
func (a *EventApiService) EventsIdGet(ctx _context.Context, id int32) (Event, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
