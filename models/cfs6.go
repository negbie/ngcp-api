...
// Validate validates this cfs6
func (m *Cfs6) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Cfs6) validateBnumberset(formats strfmt.Registry) error {
...
func (m *Cfs6) validateBnumbersetID(formats strfmt.Registry) error {
...
func (m *Cfs6) validateDestinationset(formats strfmt.Registry) error {
...
func (m *Cfs6) validateDestinationsetID(formats strfmt.Registry) error {
...
func (m *Cfs6) validateSourceset(formats strfmt.Registry) error {
...
func (m *Cfs6) validateSourcesetID(formats strfmt.Registry) error {
...
func (m *Cfs6) validateTimeset(formats strfmt.Registry) error {
...
func (m *Cfs6) validateTimesetID(formats strfmt.Registry) error {
...
func (m *Cfs6) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Cfs6) UnmarshalBinary(b []byte) error {
	var res Cfs6
