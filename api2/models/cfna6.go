...
// Validate validates this cfna6
func (m *Cfna6) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Cfna6) validateBnumberset(formats strfmt.Registry) error {
...
func (m *Cfna6) validateBnumbersetID(formats strfmt.Registry) error {
...
func (m *Cfna6) validateDestinationset(formats strfmt.Registry) error {
...
func (m *Cfna6) validateDestinationsetID(formats strfmt.Registry) error {
...
func (m *Cfna6) validateSourceset(formats strfmt.Registry) error {
...
func (m *Cfna6) validateSourcesetID(formats strfmt.Registry) error {
...
func (m *Cfna6) validateTimeset(formats strfmt.Registry) error {
...
func (m *Cfna6) validateTimesetID(formats strfmt.Registry) error {
...
func (m *Cfna6) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Cfna6) UnmarshalBinary(b []byte) error {
	var res Cfna6
