...
// Subscribers3 Subscribers3
//
// swagger:model Subscribers3
type Subscribers3 struct {
	...
	// profile id
	// Required: true
	ProfileID *float64 `json:"profile_id"`

	// profile set id
	// Required: true
	ProfileSetID *float64 `json:"profile_set_id"`
...
// Validate validates this subscribers3
func (m *Subscribers3) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Subscribers3) validateAdministrative(formats strfmt.Registry) error {
...
func (m *Subscribers3) validateAliasNumbers(formats strfmt.Registry) error {
...
func (m *Subscribers3) validateDisplayName(formats strfmt.Registry) error {
...
func (m *Subscribers3) validateDomain(formats strfmt.Registry) error {
...
func (m *Subscribers3) validateDomainID(formats strfmt.Registry) error {
...
func (m *Subscribers3) validateEmail(formats strfmt.Registry) error {
...
func (m *Subscribers3) validateExternalID(formats strfmt.Registry) error {
...
func (m *Subscribers3) validateIsPbxGroup(formats strfmt.Registry) error {
...
func (m *Subscribers3) validateIsPbxPilot(formats strfmt.Registry) error {
...
func (m *Subscribers3) validateLock(formats strfmt.Registry) error {
...
func (m *Subscribers3) validatePassword(formats strfmt.Registry) error {
...
func (m *Subscribers3) validatePbxExtension(formats strfmt.Registry) error {
...
func (m *Subscribers3) validatePbxGroupIds(formats strfmt.Registry) error {
...
func (m *Subscribers3) validatePbxGroupmemberIdsID(formats strfmt.Registry) error {
...
func (m *Subscribers3) validatePrimaryNumber(formats strfmt.Registry) error {
...
func (m *Subscribers3) validateProfileID(formats strfmt.Registry) error {
...
func (m *Subscribers3) validateProfileSetID(formats strfmt.Registry) error {
...
func (m *Subscribers3) validateStatus(formats strfmt.Registry) error {
...
func (m *Subscribers3) validateTimezone(formats strfmt.Registry) error {
...
func (m *Subscribers3) validateUsername(formats strfmt.Registry) error {
...
func (m *Subscribers3) validateWebpassword(formats strfmt.Registry) error {
...
func (m *Subscribers3) validateWebusername(formats strfmt.Registry) error {
...
func (m *Subscribers3) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Subscribers3) UnmarshalBinary(b []byte) error {
	var res Subscribers3
