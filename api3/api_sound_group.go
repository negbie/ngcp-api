...
// SoundGroupApiService SoundGroupApi service
type SoundGroupApiService service

// SoundgroupsGetOpts Optional parameters for the method 'SoundgroupsGet'
type SoundgroupsGetOpts struct {
...
/*
SoundgroupsGet Get SoundGroup items
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *SoundgroupsGetOpts - Optional Parameters:
 * @param "Name" (optional.String) -  Filter for sound groups with a specific name
...
*/
func (a *SoundGroupApiService) SoundgroupsGet(ctx _context.Context, localVarOptionals *SoundgroupsGetOpts) ([]map[string]interface{}, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/soundgroups/"
...
/*
SoundgroupsIdGet Get a specific SoundGroup
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
@return map[string]interface{}
*/
func (a *SoundGroupApiService) SoundgroupsIdGet(ctx _context.Context, id int32) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/soundgroups/{id}"
