...
// CreateanewContractRequest CreateanewContractRequest
// swagger:model CreateanewContractRequest
...
// Validate validates this createanew contract request
func (m *CreateanewContractRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CreateanewContractRequest) validateBillingProfileDefinition(formats strfmt.Registry) error {
...
func (m *CreateanewContractRequest) validateBillingProfileID(formats strfmt.Registry) error {
...
func (m *CreateanewContractRequest) validateBillingProfiles(formats strfmt.Registry) error {
...
func (m *CreateanewContractRequest) validateContactID(formats strfmt.Registry) error {
...
func (m *CreateanewContractRequest) validateExternalID(formats strfmt.Registry) error {
...
func (m *CreateanewContractRequest) validateStatus(formats strfmt.Registry) error {
...
func (m *CreateanewContractRequest) validateType(formats strfmt.Registry) error {
...
func (m *CreateanewContractRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CreateanewContractRequest) UnmarshalBinary(b []byte) error {
	var res CreateanewContractRequest
