...
// Validate validates this interception
func (m *Interception) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Interception) validateLiid(formats strfmt.Registry) error {
...
func (m *Interception) validateNumber(formats strfmt.Registry) error {
...
func (m *Interception) validateX2Host(formats strfmt.Registry) error {
...
func (m *Interception) validateX2Password(formats strfmt.Registry) error {
...
func (m *Interception) validateX2Port(formats strfmt.Registry) error {
...
func (m *Interception) validateX2User(formats strfmt.Registry) error {
...
func (m *Interception) validateX3Host(formats strfmt.Registry) error {
...
func (m *Interception) validateX3Port(formats strfmt.Registry) error {
...
func (m *Interception) validateX3Required(formats strfmt.Registry) error {
...
func (m *Interception) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Interception) UnmarshalBinary(b []byte) error {
	var res Interception
