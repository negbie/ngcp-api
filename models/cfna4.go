...
// Validate validates this cfna4
func (m *Cfna4) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Cfna4) validateBnumberset(formats strfmt.Registry) error {
...
func (m *Cfna4) validateBnumbersetID(formats strfmt.Registry) error {
...
func (m *Cfna4) validateDestinationset(formats strfmt.Registry) error {
...
func (m *Cfna4) validateDestinationsetID(formats strfmt.Registry) error {
...
func (m *Cfna4) validateSourceset(formats strfmt.Registry) error {
...
func (m *Cfna4) validateSourcesetID(formats strfmt.Registry) error {
...
func (m *Cfna4) validateTimeset(formats strfmt.Registry) error {
...
func (m *Cfna4) validateTimesetID(formats strfmt.Registry) error {
...
func (m *Cfna4) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Cfna4) UnmarshalBinary(b []byte) error {
	var res Cfna4
