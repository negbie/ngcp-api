...
// Validate validates this billing fee
func (m *BillingFee) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *BillingFee) validateBillingProfileID(formats strfmt.Registry) error {
...
func (m *BillingFee) validateBillingZoneID(formats strfmt.Registry) error {
...
func (m *BillingFee) validateDestination(formats strfmt.Registry) error {
...
func (m *BillingFee) validateDirection(formats strfmt.Registry) error {
...
func (m *BillingFee) validateMatchMode(formats strfmt.Registry) error {
...
func (m *BillingFee) validateOffpeakFollowInterval(formats strfmt.Registry) error {
...
func (m *BillingFee) validateOffpeakFollowRate(formats strfmt.Registry) error {
...
func (m *BillingFee) validateOffpeakInitInterval(formats strfmt.Registry) error {
...
func (m *BillingFee) validateOffpeakInitRate(formats strfmt.Registry) error {
...
func (m *BillingFee) validateOnpeakFollowInterval(formats strfmt.Registry) error {
...
func (m *BillingFee) validateOnpeakFollowRate(formats strfmt.Registry) error {
...
func (m *BillingFee) validateOnpeakInitInterval(formats strfmt.Registry) error {
...
func (m *BillingFee) validateOnpeakInitRate(formats strfmt.Registry) error {
...
func (m *BillingFee) validatePurgeExisting(formats strfmt.Registry) error {
...
func (m *BillingFee) validateSource(formats strfmt.Registry) error {
...
func (m *BillingFee) validateUseFreeTime(formats strfmt.Registry) error {
...
func (m *BillingFee) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *BillingFee) UnmarshalBinary(b []byte) error {
	var res BillingFee
