...
// Validate validates this cfb6
func (m *Cfb6) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Cfb6) validateBnumberset(formats strfmt.Registry) error {
...
func (m *Cfb6) validateBnumbersetID(formats strfmt.Registry) error {
...
func (m *Cfb6) validateDestinationset(formats strfmt.Registry) error {
...
func (m *Cfb6) validateDestinationsetID(formats strfmt.Registry) error {
...
func (m *Cfb6) validateSourceset(formats strfmt.Registry) error {
...
func (m *Cfb6) validateSourcesetID(formats strfmt.Registry) error {
...
func (m *Cfb6) validateTimeset(formats strfmt.Registry) error {
...
func (m *Cfb6) validateTimesetID(formats strfmt.Registry) error {
...
func (m *Cfb6) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Cfb6) UnmarshalBinary(b []byte) error {
	var res Cfb6
