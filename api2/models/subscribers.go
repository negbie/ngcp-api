...
// Validate validates this subscribers
func (m *Subscribers) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Subscribers) validateAdministrative(formats strfmt.Registry) error {
...
func (m *Subscribers) validateAliasNumbers(formats strfmt.Registry) error {
...
func (m *Subscribers) validateDisplayName(formats strfmt.Registry) error {
...
func (m *Subscribers) validateDomain(formats strfmt.Registry) error {
...
func (m *Subscribers) validateDomainID(formats strfmt.Registry) error {
...
func (m *Subscribers) validateEmail(formats strfmt.Registry) error {
...
func (m *Subscribers) validateExternalID(formats strfmt.Registry) error {
...
func (m *Subscribers) validateIsPbxGroup(formats strfmt.Registry) error {
...
func (m *Subscribers) validateIsPbxPilot(formats strfmt.Registry) error {
...
func (m *Subscribers) validateLock(formats strfmt.Registry) error {
...
func (m *Subscribers) validatePassword(formats strfmt.Registry) error {
...
func (m *Subscribers) validatePbxExtension(formats strfmt.Registry) error {
...
func (m *Subscribers) validatePbxGroupIds(formats strfmt.Registry) error {
...
func (m *Subscribers) validatePbxGroupmemberIdsID(formats strfmt.Registry) error {
...
func (m *Subscribers) validatePrimaryNumber(formats strfmt.Registry) error {
...
func (m *Subscribers) validateProfileID(formats strfmt.Registry) error {
...
func (m *Subscribers) validateProfileSetID(formats strfmt.Registry) error {
...
func (m *Subscribers) validateStatus(formats strfmt.Registry) error {
...
func (m *Subscribers) validateTimezone(formats strfmt.Registry) error {
...
func (m *Subscribers) validateUsername(formats strfmt.Registry) error {
...
func (m *Subscribers) validateWebpassword(formats strfmt.Registry) error {
...
func (m *Subscribers) validateWebusername(formats strfmt.Registry) error {
...
func (m *Subscribers) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Subscribers) UnmarshalBinary(b []byte) error {
	var res Subscribers
