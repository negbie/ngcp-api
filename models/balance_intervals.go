...
// Validate validates this balance intervals
func (m *BalanceIntervals) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *BalanceIntervals) validateBillingProfileID(formats strfmt.Registry) error {
...
func (m *BalanceIntervals) validateCashBalance(formats strfmt.Registry) error {
...
func (m *BalanceIntervals) validateCashDebit(formats strfmt.Registry) error {
...
func (m *BalanceIntervals) validateFreeTimeBalance(formats strfmt.Registry) error {
...
func (m *BalanceIntervals) validateFreeTimeSpent(formats strfmt.Registry) error {
...
func (m *BalanceIntervals) validateInitialCashBalance(formats strfmt.Registry) error {
...
func (m *BalanceIntervals) validateInitialFreeTimeBalance(formats strfmt.Registry) error {
...
func (m *BalanceIntervals) validateIsActual(formats strfmt.Registry) error {
...
func (m *BalanceIntervals) validateNotopupDiscardExpiry(formats strfmt.Registry) error {
...
func (m *BalanceIntervals) validateStart(formats strfmt.Registry) error {
...
func (m *BalanceIntervals) validateStop(formats strfmt.Registry) error {
...
func (m *BalanceIntervals) validateTimelyTopupCount(formats strfmt.Registry) error {
...
func (m *BalanceIntervals) validateTimelyTopupStart(formats strfmt.Registry) error {
...
func (m *BalanceIntervals) validateTimelyTopupStop(formats strfmt.Registry) error {
...
func (m *BalanceIntervals) validateTopupCount(formats strfmt.Registry) error {
...
func (m *BalanceIntervals) validateUnderrunLock(formats strfmt.Registry) error {
...
func (m *BalanceIntervals) validateUnderrunProfiles(formats strfmt.Registry) error {
...
func (m *BalanceIntervals) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *BalanceIntervals) UnmarshalBinary(b []byte) error {
	var res BalanceIntervals
