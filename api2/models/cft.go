...
// Validate validates this cft
func (m *Cft) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Cft) validateBnumbers(formats strfmt.Registry) error {
...
func (m *Cft) validateBnumbersIsRegex(formats strfmt.Registry) error {
...
func (m *Cft) validateBnumbersMode(formats strfmt.Registry) error {
...
func (m *Cft) validateDestinations(formats strfmt.Registry) error {
...
func (m *Cft) validateRingtimeout(formats strfmt.Registry) error {
...
func (m *Cft) validateSources(formats strfmt.Registry) error {
...
func (m *Cft) validateSourcesIsRegex(formats strfmt.Registry) error {
...
func (m *Cft) validateSourcesMode(formats strfmt.Registry) error {
...
func (m *Cft) validateTimes(formats strfmt.Registry) error {
...
func (m *Cft) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Cft) UnmarshalBinary(b []byte) error {
	var res Cft
