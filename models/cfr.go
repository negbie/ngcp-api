...
// Validate validates this cfr
func (m *Cfr) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Cfr) validateBnumbers(formats strfmt.Registry) error {
...
func (m *Cfr) validateBnumbersIsRegex(formats strfmt.Registry) error {
...
func (m *Cfr) validateBnumbersMode(formats strfmt.Registry) error {
...
func (m *Cfr) validateDestinations(formats strfmt.Registry) error {
...
func (m *Cfr) validateSources(formats strfmt.Registry) error {
...
func (m *Cfr) validateSourcesIsRegex(formats strfmt.Registry) error {
...
func (m *Cfr) validateSourcesMode(formats strfmt.Registry) error {
...
func (m *Cfr) validateTimes(formats strfmt.Registry) error {
...
func (m *Cfr) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Cfr) UnmarshalBinary(b []byte) error {
	var res Cfr
