...
// Validate validates this thenewlycreateditemorempty6
...
func (m *Thenewlycreateditemorempty6) validateSubscriberID(formats strfmt.Registry) error {
...
func (m *Thenewlycreateditemorempty6) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Thenewlycreateditemorempty6) UnmarshalBinary(b []byte) error {
	var res Thenewlycreateditemorempty6
