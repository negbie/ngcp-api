...
// Validate validates this cfr5
func (m *Cfr5) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Cfr5) validateBnumberset(formats strfmt.Registry) error {
...
func (m *Cfr5) validateBnumbersetID(formats strfmt.Registry) error {
...
func (m *Cfr5) validateDestinationset(formats strfmt.Registry) error {
...
func (m *Cfr5) validateDestinationsetID(formats strfmt.Registry) error {
...
func (m *Cfr5) validateSourceset(formats strfmt.Registry) error {
...
func (m *Cfr5) validateSourcesetID(formats strfmt.Registry) error {
...
func (m *Cfr5) validateTimeset(formats strfmt.Registry) error {
...
func (m *Cfr5) validateTimesetID(formats strfmt.Registry) error {
...
func (m *Cfr5) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Cfr5) UnmarshalBinary(b []byte) error {
	var res Cfr5
