...
// Validate validates this cfna5
func (m *Cfna5) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Cfna5) validateBnumberset(formats strfmt.Registry) error {
...
func (m *Cfna5) validateBnumbersetID(formats strfmt.Registry) error {
...
func (m *Cfna5) validateDestinationset(formats strfmt.Registry) error {
...
func (m *Cfna5) validateDestinationsetID(formats strfmt.Registry) error {
...
func (m *Cfna5) validateSourceset(formats strfmt.Registry) error {
...
func (m *Cfna5) validateSourcesetID(formats strfmt.Registry) error {
...
func (m *Cfna5) validateTimeset(formats strfmt.Registry) error {
...
func (m *Cfna5) validateTimesetID(formats strfmt.Registry) error {
...
func (m *Cfna5) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Cfna5) UnmarshalBinary(b []byte) error {
	var res Cfna5
