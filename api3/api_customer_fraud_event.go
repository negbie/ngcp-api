...
// CustomerFraudEventApiService CustomerFraudEventApi service
type CustomerFraudEventApiService service

// CustomerfraudeventsGetOpts Optional parameters for the method 'CustomerfraudeventsGet'
type CustomerfraudeventsGetOpts struct {
...
/*
CustomerfraudeventsGet Get CustomerFraudEvent items
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *CustomerfraudeventsGetOpts - Optional Parameters:
 * @param "ResellerId" (optional.String) -  Filter for fraud events belonging to a specific reseller
 * @param "Interval" (optional.String) -  Interval filter. values: day, month. default: month
...
@return []CustomerFraudEvent
*/
func (a *CustomerFraudEventApiService) CustomerfraudeventsGet(ctx _context.Context, localVarOptionals *CustomerfraudeventsGetOpts) ([]CustomerFraudEvent, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  []CustomerFraudEvent
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/customerfraudevents/"
...
/*
CustomerfraudeventsIdGet Get a specific CustomerFraudEvent
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
@return CustomerFraudEvent
*/
func (a *CustomerFraudEventApiService) CustomerfraudeventsIdGet(ctx _context.Context, id int32) (CustomerFraudEvent, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/customerfraudevents/{id}"
