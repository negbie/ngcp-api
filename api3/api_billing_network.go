...
// BillingNetworkApiService BillingNetworkApi service
type BillingNetworkApiService service

// BillingnetworksGetOpts Optional parameters for the method 'BillingnetworksGet'
type BillingnetworksGetOpts struct {
...
/*
BillingnetworksGet Get BillingNetwork items
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *BillingnetworksGetOpts - Optional Parameters:
 * @param "ResellerId" (optional.String) -  Filter for billing networks belonging to a specific reseller
 * @param "Ip" (optional.String) -  Filter for billing networks containing a specific IP address
 * @param "Name" (optional.String) -  Filter for billing networks matching a name pattern
...
/*
BillingnetworksIdGet Get a specific BillingNetwork
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
@return BillingNetwork
*/
...
/*
BillingnetworksIdPatch Change a specific BillingNetwork
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param operation A JSON patch document specifying modifications
@return BillingNetwork
*/
func (a *BillingNetworkApiService) BillingnetworksIdPatch(ctx _context.Context, id int32, operation []Operation) (BillingNetwork, *_nethttp.Response, error) {
	var (
...
/*
BillingnetworksIdPut Replace/change a specific BillingNetwork
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param billingNetwork
@return BillingNetwork
*/
func (a *BillingNetworkApiService) BillingnetworksIdPut(ctx _context.Context, id int32, billingNetwork BillingNetwork) (BillingNetwork, *_nethttp.Response, error) {
	var (
	...
	// body params
	localVarPostBody = &billingNetwork
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
/*
BillingnetworksPost Create a new BillingNetwork
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param billingNetwork
@return []BillingNetwork
*/
func (a *BillingNetworkApiService) BillingnetworksPost(ctx _context.Context, billingNetwork BillingNetwork) ([]BillingNetwork, *_nethttp.Response, error) {
	var (
