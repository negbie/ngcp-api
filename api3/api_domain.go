...
// DomainsGetOpts Optional parameters for the method 'DomainsGet'
type DomainsGetOpts struct {
...
/*
DomainsGet Get Domain items
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *DomainsGetOpts - Optional Parameters:
 * @param "ResellerId" (optional.String) -  Filter for domains belonging to a specific reseller
 * @param "Domain" (optional.String) -  Filter for domains matching the given pattern
...
@return []Domain
*/
func (a *DomainApiService) DomainsGet(ctx _context.Context, localVarOptionals *DomainsGetOpts) ([]Domain, *_nethttp.Response, error) {
	var (
...
/*
DomainsIdDelete Delete a specific Domain
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
*/
func (a *DomainApiService) DomainsIdDelete(ctx _context.Context, id int32) (*_nethttp.Response, error) {
	var (
...
/*
DomainsIdGet Get a specific Domain
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
@return Domain
*/
func (a *DomainApiService) DomainsIdGet(ctx _context.Context, id int32) (Domain, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
DomainsPost Create a new Domain
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param domain
@return []Domain
*/
func (a *DomainApiService) DomainsPost(ctx _context.Context, domain Domain) ([]Domain, *_nethttp.Response, error) {
	var (
