...
// VoicemailsGetOpts Optional parameters for the method 'VoicemailsGet'
type VoicemailsGetOpts struct {
    Tz optional.String
...
/*
VoicemailsGet Get Voicemail items
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *VoicemailsGetOpts - Optional Parameters:
 ...
 * @param "SubscriberId" (optional.String) -  Filter for voicemails belonging to a specific subscriber
 * @param "Folder" (optional.String) -  Filter for voicemails in a specific folder (one of INBOX, Old, Friends, Family, Cust1 to Cust4)
...
@return []Voicemail
*/
func (a *VoicemailApiService) VoicemailsGet(ctx _context.Context, localVarOptionals *VoicemailsGetOpts) ([]Voicemail, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/voicemails/"
...
/*
VoicemailsIdDelete Delete a specific Voicemail
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
*/
func (a *VoicemailApiService) VoicemailsIdDelete(ctx _context.Context, id int32) (*_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/voicemails/{id}"
...
/*
VoicemailsIdGet Get a specific Voicemail
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
@return Voicemail
*/
func (a *VoicemailApiService) VoicemailsIdGet(ctx _context.Context, id int32) (Voicemail, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
VoicemailsIdPatch Change a specific Voicemail
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param operation A JSON patch document specifying modifications
@return Voicemail
*/
func (a *VoicemailApiService) VoicemailsIdPatch(ctx _context.Context, id int32, operation []Operation) (Voicemail, *_nethttp.Response, error) {
	var (
...
/*
VoicemailsIdPut Replace/change a specific Voicemail
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param voicemail
@return Voicemail
*/
func (a *VoicemailApiService) VoicemailsIdPut(ctx _context.Context, id int32, voicemail Voicemail) (Voicemail, *_nethttp.Response, error) {
	var (
